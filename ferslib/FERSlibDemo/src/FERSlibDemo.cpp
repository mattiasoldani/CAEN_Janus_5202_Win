// FERSlibDemo.cpp : This file contains the 'main' function. Program execution begins and ends there.
//

#include "FERSlibDemo.h"
...
#define DEFAULT_CONFIG_FILENAME  "FERSlib_Config.txt"
...
int CheckRunTimeCmd(Demo_t* tcfg)
{
    ...
    if (c == 'C' && tcfg->acq_status == ACQSTATUS_READY) return 2;
    if (c == 'l' && tcfg->acq_status == ACQSTATUS_READY) return 3;
    if (c == ' ') {
        printf("\n");
        printf("[q] Quit\n");
